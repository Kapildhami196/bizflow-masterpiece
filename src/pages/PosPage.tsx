...
const PosPage = () => {
  ...
  const [taxRate] = useState(13); // VAT 13%
            ...
            <div className="mx-4 mt-3 bg-card rounded-xl border border-border p-4">
              ...
              <div className="space-y-1.5 text-sm border-t border-border pt-2">
                <div className="flex justify-between">
                  ...
                  <span className="text-card-foreground">NPR {grossAmount.toLocaleString()}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-muted-foreground">VAT ({taxRate}%)</span>
                  <span className="text-card-foreground">NPR {taxAmount.toLocaleString()}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-muted-foreground">Discount (-)</span>
                  <span className="text-card-foreground">NPR {discountAmount.toLocaleString()}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-muted-foreground">Surcharge</span>
                  <span className="text-card-foreground">NPR {surcharge.toLocaleString()}</span>
                </div>
              </div>
