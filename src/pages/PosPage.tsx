    ...
    <div className="flex flex-col min-h-screen max-w-md mx-auto bg-background relative">
          ...
          <div className="bg-card rounded-xl border border-border p-3 space-y-2">
            ...
            <div className="grid grid-cols-3 gap-2">
              ...
              <button
                onClick={() => {
                  ...
                  setSurcharge(0);
                  toast("Cart cleared", { duration: 1200 });
                }}
              ...
              <button
                onClick={() => cart.length > 0 && toast.info("Split bill feature")}
                className={`py-3 rounded-xl text-xs font-bold flex flex-col items-center gap-1 transition-all active:scale-95 ${
                  cart.length > 0
            ...
            <div className="grid grid-cols-2 gap-2">
              <button
                ...
                className={`py-2.5 rounded-xl text-[11px] font-semibold flex items-center justify-center gap-1.5 transition-all active:scale-95 ${
                  discountPercent > 0
                    ? "bg-primary/10 text-primary border border-primary/30 ring-1 ring-primary/10"
              ...
              <button
                onClick={() => setSurcharge(prev => prev > 0 ? 0 : 50)}
                className={`py-2.5 rounded-xl text-[11px] font-semibold flex items-center justify-center gap-1.5 transition-all active:scale-95 ${
                  surcharge > 0
                    ? "bg-primary/10 text-primary border border-primary/30 ring-1 ring-primary/10"
                    : "bg-background border border-border text-muted-foreground hover:text-card-foreground"
              ...
              >
                <Plus size={12} />
                Surcharge {surcharge > 0 ? `NPR ${surcharge}` : ""}
              </button>
            </div>
          </div>
        </div>
      ...
      {cart.length > 0 && (
        <div className="fixed bottom-0 left-0 right-0 max-w-md mx-auto bg-card border-t border-border px-4 py-3 safe-bottom z-30">
          <button
            onClick={() => toast.success("Processing payment...")}
            className="w-full bg-primary text-primary-foreground py-3.5 rounded-xl font-bold text-sm flex items-center justify-center gap-2 shadow-lg active:scale-[0.98] transition-transform"
          >
